...
describe('Connect Cloud Health test suite', () => {
    ...
    it('Liveness returns 200 OK and UP on liveness success', (done) => {
        ...
        // tslint:disable-next-line:no-shadowed-variable
        new index_1.LivenessCheck("test1", () => new Promise(function (resolve, _reject) {
            resolve();
        })));
        const reqStub = {};
        const nextStub = {};
    ...
    it('Liveness returns 503 Unavailable and DOWN on liveness fail', (done) => {
        let cloudHealth = new index_1.HealthChecker();
        cloudHealth.registerLivenessCheck(
        // tslint:disable-next-line:no-shadowed-variable
        new index_1.LivenessCheck("test1", () => new Promise((_resolve, _reject) => {
    ...
    it('Liveness returns 503 OK and STOPPING on STOPPING', (done) => {
        process.removeAllListeners('SIGTERM');
        let cloudHealth = new index_1.HealthChecker();
        cloudHealth.registerShutdownCheck(
        // tslint:disable-next-line:no-shadowed-variable
        new index_1.ShutdownCheck("test1", () => new Promise((_resolve, _reject) => {
    ...
    it('Liveness returns 503 OK and STOPPED on STOPPED', (done) => {
        process.removeAllListeners('SIGTERM');
        let cloudHealth = new index_1.HealthChecker();
    ...
    it('Readiness returns 503 Unavailable and DOWN on startup fail', (done) => {
        let cloudHealth = new index_1.HealthChecker();
        cloudHealth.registerStartupCheck(
        // tslint:disable-next-line:no-shadowed-variable
        new index_1.StartupCheck("test1", () => new Promise((_resolve, _reject) => {
    ...
    it('Readiness returns 503 Unavailable startup check starting', (done) => {
        let cloudHealth = new index_1.HealthChecker();
        const startupPromise = () => new Promise((_resolve, reject) => {
            setTimeout(reject, 100, 'foo');
        });
        let startCheck = new index_1.StartupCheck('StartCheck', startupPromise);
    ...
    it('Readiness returns 200 OK and UP on startup and liveness checks', (done) => {
        let cloudHealth = new index_1.HealthChecker();
        cloudHealth.registerStartupCheck(
        // tslint:disable-next-line:no-shadowed-variable
        new index_1.StartupCheck("startup", () => new Promise((resolve, reject) => {
            resolve();
        })))
            .then(() => {
            index_1.ReadinessEndpoint(cloudHealth)(reqStub, resStub, nextStub);
        ...
        // tslint:disable-next-line:no-shadowed-variable
        new index_1.LivenessCheck("readiness", () => new Promise((resolve, _reject) => {
            resolve();
        })));
        const reqStub = {};
        const nextStub = {};
    ...
    it('Readiness returns 503 OK and STOPPING on STOPPING', (done) => {
        process.removeAllListeners('SIGTERM');
        let cloudHealth = new index_1.HealthChecker();
        cloudHealth.registerShutdownCheck(
        // tslint:disable-next-line:no-shadowed-variable
    ...
    it('Readiness returns 503 OK and STOPPED on STOPPED', (done) => {
        process.removeAllListeners('SIGTERM');
        let cloudHealth = new index_1.HealthChecker();
        const promiseone = () => new Promise((resolve, _reject) => {
            setTimeout(resolve, 1);
    ...
    it('Health returns 200 OK and UP on liveness success', (done) => {
        let cloudHealth = new index_1.HealthChecker();
        cloudHealth.registerLivenessCheck(
        // tslint:disable-next-line:no-shadowed-variable
    ...
    it('Health returns 503 Unavailable and DOWN on liveness fail', (done) => {
        let cloudHealth = new index_1.HealthChecker();
        cloudHealth.registerLivenessCheck(
        // tslint:disable-next-line:no-shadowed-variable
        new index_1.LivenessCheck("test1", () => new Promise((_resolve, _reject) => {
    ...
    it('Health returns 503 OK and STOPPING on STOPPING', (done) => {
        process.removeAllListeners('SIGTERM');
        let cloudHealth = new index_1.HealthChecker();
        cloudHealth.registerShutdownCheck(
        // tslint:disable-next-line:no-shadowed-variable
    ...
    it('Health returns 503 OK and STOPPED on STOPPED', (done) => {
        process.removeAllListeners('SIGTERM');
        let cloudHealth = new index_1.HealthChecker();
        const promiseone = () => new Promise((resolve, _reject) => {
            setTimeout(resolve, 1);
