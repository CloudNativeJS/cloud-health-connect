...
      // tslint:disable-next-line:no-shadowed-variable
      new LivenessCheck("test1", () => new Promise<void>(function(resolve, _reject){
        resolve();
      }))
    )
...
    cloudHealth.registerLivenessCheck(
      // tslint:disable-next-line:no-shadowed-variable
      new LivenessCheck("test1", () => new Promise<void>((_resolve, _reject) => {
...
      // tslint:disable-next-line:no-shadowed-variable
      new ShutdownCheck("test1", () => new Promise<void>((_resolve, _reject) => {
...
    cloudHealth.registerStartupCheck(
      // tslint:disable-next-line:no-shadowed-variable
      new StartupCheck("test1", () => new Promise<void>((_resolve, _reject) => {
...
    let startCheck = new StartupCheck('StartCheck', startupPromise);
...
    cloudHealth.registerStartupCheck(
      // tslint:disable-next-line:no-shadowed-variable
      new StartupCheck("startup", () => new Promise<void>((resolve, reject) => {
        resolve();
      }))
    )
    .then(() => {
...
      // tslint:disable-next-line:no-shadowed-variable
      new LivenessCheck("readiness", () => new Promise<void>((resolve, _reject) => {
        resolve();
      }))
    )
